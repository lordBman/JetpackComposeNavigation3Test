...
import com.bsoft.navigation3test.viewmodels.RegisterViewModel

@Composable
fun RegisterScreen(
    modifier: Modifier = Modifier, viewModel: RegisterViewModel = viewModel(), sharedViewModel: AuthSharedViewModel = viewModel(),
) {
